...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
  ...
  array1 = arrayWithquote.split(",");
  console.log(array);

  array = new RegExp(array1.join("|"), "i");
  ...
  function checkRegex(regex) {
    ...
    console.log("Not valid regular expression");

    return false;
  }

  if (checkRegex(array)) {
    console.log("Valid regular expression");
    var context = document.querySelector("body");
    var instance = new Mark(context);
    instance.markRegExp(array, {
